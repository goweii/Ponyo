...
import per.goweii.ponyo.net.data.NetworkRecord;
...
public class NetworkManager {
     ...
     * 的数据量不会很大，直接foreach
     */
    private final List<NetworkRecord> mRecords = Collections.synchronizedList(new ArrayList<NetworkRecord>());
